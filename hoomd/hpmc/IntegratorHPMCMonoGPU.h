...
class IntegratorHPMCMonoGPU : public IntegratorHPMCMono<Shape>
    ...
    protected:
        ...
        std::unique_ptr<Autotuner> m_tuner_energies;         //!< Autotuner for summing energies
...
IntegratorHPMCMonoGPU< Shape >::IntegratorHPMCMonoGPU(std::shared_ptr<SystemDefinition> sysdef,
    ...
    m_tuner_energies.reset(new Autotuner(valid_params_energies, 5, 100000, "hpmc_energies", this->m_exec_conf));
