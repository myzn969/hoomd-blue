...
class JITDepletantsAuxiliaryPhase1
    {
    public:
        JITDepletantsAuxiliaryPhase1(std::shared_ptr<const ExecutionConfiguration>& exec_conf)
...
class JITDepletantsAuxiliaryPhase1Impl {};

//! Launcher for hpmc_insert_depletants_phase1 kernel with templated launch bounds
template<class Shape>
class JITDepletantsAuxiliaryPhase1Impl<Shape, PatchEnergyJITGPU> : public JITDepletantsAuxiliaryPhase1<Shape>
    {
    public:
        ...
        JITDepletantsAuxiliaryPhase1Impl(std::shared_ptr<const ExecutionConfiguration>& exec_conf,
                       std::shared_ptr<JIT> jit)
            : JITDepletantsAuxiliaryPhase1<Shape>(exec_conf),
        ...
        virtual void operator()(
            ...
            for (int idev = auxiliary_args.gpu_partition_rank.getNumActiveGPUs() - 1; idev >= 0; --idev)
                ...
                CUresult res = launcher(args.d_trial_postype,
                                     ...
                                     auxiliary_args.d_deltaF_or_nneigh,
                                     auxiliary_args.d_deltaF_or_nlist,
                                     auxiliary_args.d_deltaF_or_len,
                                     auxiliary_args.d_deltaF_or_energy,
                                     auxiliary_args.d_deltaF_or,
                                     auxiliary_args.d_deltaF_or_config,
                                     auxiliary_args.deltaF_or_maxlen,
                                     auxiliary_args.d_overflow_or,
...
//! Launcher for hpmc_insert_depletants_phase1 kernel with templated launch bounds
template<class Shape>
class JITDepletantsAuxiliaryPhase1Impl<Shape, PatchEnergyJITUnionGPU> : public JITDepletantsAuxiliaryPhase1<Shape>
    {
    public:
